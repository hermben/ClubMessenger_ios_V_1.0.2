...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "$PODS_CONFIGURATION_BUILD_DIR/QMServices-iOS8.1/QMChatCacheModel.bundle"
  install_resource "$PODS_CONFIGURATION_BUILD_DIR/QMServices-iOS8.1/QMContactListCacheModel.bundle"
  install_resource "$PODS_CONFIGURATION_BUILD_DIR/QMServices-iOS8.1/QMUsersCacheModel.bundle"
