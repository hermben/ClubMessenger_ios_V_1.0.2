...
+ (BFTask *)loadMe {
    ...
    [parameters setValue:@"picture.type(large),id,name,email,about,age_range,bio,birthday,context,education,first_name,is_shared_login,last_name,link,middle_name,verified,website,work,cover,permissions,gender,location" forKey:@"fields"];
    FBSDKGraphRequest *friendsRequest = [[FBSDKGraphRequest alloc] initWithGraphPath:@"me" parameters:parameters];
