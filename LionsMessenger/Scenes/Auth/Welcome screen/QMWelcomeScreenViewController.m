...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.lblAppName.text = NSLocalizedString(@"app_name", nil);
    [self.btnLogin setTitle:NSLocalizedString(@"landing_already_have_account", nil) forState:UIControlStateNormal];
    [self.btnSignup setTitle:NSLocalizedString(@"landing_sign_up", nil) forState:UIControlStateNormal];
...
- (IBAction)loginWithEmailOrSocial:(UIButton *)__unused sender {
