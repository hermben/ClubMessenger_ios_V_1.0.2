...
- (void)viewDidLoad {
    ...
    strQBUserId  = [NSString stringWithFormat:@"%lu",[QMCore instance].currentProfile.userData.ID];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.imageProfilePic.layer.cornerRadius = 20;
    self.imageProfilePic.clipsToBounds = YES;
    
    self.lblName.text =  [QMCore instance].currentProfile.userData.fullName;
    NSURL *userImageUrl = [NSURL URLWithString:[QMCore instance].currentProfile.userData.avatarUrl];
    [self.imageProfilePic sd_setImageWithURL:userImageUrl placeholderImage:[UIImage imageNamed:@"upic_avatarholder"]];
